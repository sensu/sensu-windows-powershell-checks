...
#
# USAGE:
#   Powershell.exe -NonInteractive -NoProfile -ExecutionPolicy Bypass -NoLogo -File C:\\opt\\sensu\\plugins\\metrics-windows-pagefile.ps1
#
# NOTES:
#
# LICENSE:
